...
image_path   = "./IMAGES/city_2.jpg"
video_path   = "./IMAGES/test.mp4"

yolo = Load_Yolo_model()
detect_image(yolo, image_path, "./IMAGES/city_detect.jpg", input_size=YOLO_INPUT_SIZE, show=True, CLASSES=TRAIN_CLASSES, rectangle_colors=(255,0,0))
...
#detect_realtime(yolo, '1', input_size=YOLO_INPUT_SIZE, show=True, CLASSES=TRAIN_CLASSES, rectangle_colors=(255, 0, 0))
